...
// 3. pre-run appended it, let Module = {}; ..generated code..
// 4. External script tag defines let Module.
// We need to check if Module already exists (e.g. case 3 above).
// Substitution will be replaced with actual code on later stage of the build,
// this way Closure Compiler will not mangle it (e.g. case 4. above).
// Note that if you want to run closure, and also to use Module
// after the generated code, you will need to define   let Module = {};
...
function allocateUTF8(str) {
  ...
  const ret = abort('malloc was not included, but is needed in allocateUTF8. Adding "_malloc" to EXPORTED_FUNCTIONS should fix that. This may be a bug in the compiler, please file an issue.');
...
function writeStringToMemory(string, buffer, dontAddNull) {
  ...
  let /** @type {number} */ lastChar, /** @type {number} */ end;
  if (dontAddNull) {
...
/** @type {function(...*):?} */
const stackRestore = Module["stackRestore"] = createExportWrapper("stackRestore");

/** @type {function(...*):?} */
let stackAlloc = Module["stackAlloc"] = createExportWrapper("stackAlloc");

/** @type {function(...*):?} */
let _emscripten_stack_init = Module["_emscripten_stack_init"] = function () {
  return (_emscripten_stack_init = Module["_emscripten_stack_init"] = Module["asm"]["emscripten_stack_init"]).apply(null, arguments);
};

/** @type {function(...*):?} */
let _emscripten_stack_get_free = Module["_emscripten_stack_get_free"] = function () {
